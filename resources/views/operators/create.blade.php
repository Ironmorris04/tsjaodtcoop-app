...
<head>
    ...
    <title>Create Operator - Transport Coop System</title>
...
<body class="register-page">
    <div class="register-container">
        ...
        <div class="header-card">
            <h2><i class="fas fa-user-plus"></i> Create New Operator</h2>
            <p>Please fill out all required information to register a new operator</p>
        </div>

        <form method="POST" action="{{ route('operators.store') }}" enctype="multipart/form-data" id="operatorForm">
            @csrf
            ...
            <div class="form-section">
                ...
                <div class="alert alert-info" style="margin-top: 1rem;">
                    ...
                    <strong>Note:</strong> The operator will set up their password after their account is created by the admin.
                </div>
            </div>
            ...
            <div class="form-section">
                <div class="form-actions">
                    <a href="{{ route('operators.index') }}" class="btn btn-secondary btn-lg">
                        <i class="fas fa-times"></i> Cancel
                    </a>
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fas fa-check"></i> Create Operator
                    </button>
                </div>
            </div>
        </form>
    ...
    <script>
        ...
        // Validate phone number input to allow only 11 digits
